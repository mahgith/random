...
def evaluate_op(
    ...
    try:
        ...
        mean_mae_baseline  = float(res_baseline["abs_error"].mean())
        ...
        p(f"model    WAPE={mean_wape_model:.4f}  MAPE={mean_mape_model:.4f}  MAE={mean_mae_model:.1f}")
        p(f"baseline WAPE={mean_wape_baseline:.4f}  MAPE={mean_mape_baseline:.4f}  MAE={mean_mae_baseline:.1f}")
        ...
        evaluation_metrics.log_metric("mean_mae_model",     round(mean_mae_model,     2))
        ...
        evaluation_metrics.log_metric("mean_mae_baseline",  round(mean_mae_baseline,  2))
